    ...
    <!-- Mobile menu button -->
      ...
      <!-- Logotipo -->
        <a href="/" class="flex-shrink-0 flex items-center">
          ...
          <img class="hidden lg:block h-8 w-auto" src="https://upload.wikimedia.org/wikipedia/commons/3/31/Blogger.svg" alt="Workflow">
        </a>
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <div class="ml-3 relative" x-data="{open: false}">
          ...
          <!-- Aplicamos para que pueda ver el menu Dashboard dependiendo de que rol tenga  -->
            @can('admin.home')
